...
const AuthButtonsComponent: React.FC<buttonProps> = ({ type, onPress, title }) => {
    return (
        <TouchableOpacity style={{ alignItems: 'center' }} onPress={() => onPress(title)}>
    ...
    return (
        <View style={{ ...styles.cardSty }}>
            <View style={{ justifyContent: 'center', alignItems: 'center', width: '100%', height: '80%' }}>
                <Animated.Image source={LOGO} style={{ width: '40%', opacity: logoAnimate }} />
            </View>
